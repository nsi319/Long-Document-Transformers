...
import transformersv4
from transformersv4 import (
    AutoConfig,
...
from transformersv4.trainer_utils import is_main_process
...
class DataTrainingArguments:
    ...
    longmodel: Optional[bool] = field (
      default=False, metadata={"help": "This specifies whether the given model is a long model or not."}
    )
...
def main():
    ...
    if is_main_process(training_args.local_rank):
        transformersv4.utils.logging.set_verbosity_info()
    ...
    if data_args.longmodel:
        model = LongBartForConditionalGeneration.from_pretrained(
